...
public class DocumentoElectronico extends DocumentoTrasladoBienesArmas {
    ...
    public DocumentoElectronico(String nombreVendedor, String rucEmpresa, String direccionEmpresa,
                                 String nombreCliente, String dniCliente, String direccionCliente,
                                 LocalDate fechaEmision, String descripcionBienes, double montoTotal,
                                 String arma, String codSunat, String Sucamet) {
        super(nombreVendedor, arma, descripcionBienes, direccionCliente, rucEmpresa, direccionEmpresa,
              nombreCliente, dniCliente, fechaEmision, montoTotal);
